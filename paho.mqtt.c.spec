...
%prep
%setup -q -n paho.mqtt.c-1.3.10
cd %{_builddir}/paho.mqtt.c-1.3.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661970892
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpaho-mqtt3a.so.1.3.10
/usr/lib64/libpaho-mqtt3as.so.1
/usr/lib64/libpaho-mqtt3as.so.1.3.10
/usr/lib64/libpaho-mqtt3c.so.1
/usr/lib64/libpaho-mqtt3c.so.1.3.10
/usr/lib64/libpaho-mqtt3cs.so.1
/usr/lib64/libpaho-mqtt3cs.so.1.3.10
