...
Source0  : https://github.com/eclipse/paho.mqtt.c/archive/v1.3.2/paho.mqtt.c-1.3.2.tar.gz
...
%prep
%setup -q -n paho.mqtt.c-1.3.2
cd %{_builddir}/paho.mqtt.c-1.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588183785
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/paho.mqtt.c-1.3.2/LICENSE %{buildroot}/usr/share/package-licenses/paho.mqtt.c/aab0892612c8a4e5a72be5ae714311471d3b9aaf
cp %{_builddir}/paho.mqtt.c-1.3.2/debian/copyright %{buildroot}/usr/share/package-licenses/paho.mqtt.c/2a4ffd8d67e8d28099427a6be1dad8e22865f4bc
pushd clr-build
%make_install
popd
...
/usr/lib64/libpaho-mqtt3a.so.1.3.2
/usr/lib64/libpaho-mqtt3as.so.1
/usr/lib64/libpaho-mqtt3as.so.1.3.2
/usr/lib64/libpaho-mqtt3c.so.1
/usr/lib64/libpaho-mqtt3c.so.1.3.2
/usr/lib64/libpaho-mqtt3cs.so.1
/usr/lib64/libpaho-mqtt3cs.so.1.3.2
