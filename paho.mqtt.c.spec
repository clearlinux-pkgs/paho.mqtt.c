...
Source0  : https://github.com/eclipse/paho.mqtt.c/archive/v1.3.8/paho.mqtt.c-1.3.8.tar.gz
...
%prep
%setup -q -n paho.mqtt.c-1.3.8
cd %{_builddir}/paho.mqtt.c-1.3.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609886094
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/paho.mqtt.c-1.3.8/epl-v20 %{buildroot}/usr/share/package-licenses/paho.mqtt.c/b086d72d0fe9af38418dab524fe76eea3cb1eec3
pushd clr-build
%make_install
popd
...
/usr/lib64/libpaho-mqtt3a.so.1.3.8
/usr/lib64/libpaho-mqtt3as.so.1
/usr/lib64/libpaho-mqtt3as.so.1.3.8
/usr/lib64/libpaho-mqtt3c.so.1
/usr/lib64/libpaho-mqtt3c.so.1.3.8
/usr/lib64/libpaho-mqtt3cs.so.1
/usr/lib64/libpaho-mqtt3cs.so.1.3.8
